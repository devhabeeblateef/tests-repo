...
function Profile() {
  return (
    ...
    <div className='flex justify-center pt-8'>
        ...
        <svg className=" rounded-full border p-2 absolute  ml-[40%]" xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="currentColor" class="bi bi-three-dots" viewBox="0 0 16 16">
